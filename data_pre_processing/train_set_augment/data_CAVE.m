...
savePath=['/data2/cys/data/',data_type,'/process_train/',num2str(upscale_factor),'/'];
if ~exist(savePath, 'dir')
    mkdir(savePath)
end

%% 
srPath = '/data2/cys/data/CAVE/train/';  %source data downlaoded from website 
...
for index = 1:length(srfileNames)
    ...
    % disp(['SinglePath:',singlePath,'Band Num: ',num2str(Band)])
